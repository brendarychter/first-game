...
Game.prototype = {
  ...
  preload: function () {
    this.optionCount = 1;
    game.load.image('bird', 'assets/images/index.png');
    game.load.image('pipe', 'assets/images/bmo.png');
    game.load.audio('jump', 'assets/bgm/jump.wav'); 
  },

  addMenuOption: function(text, callback) {
    var optionStyle = { font: '30pt Nexa', fill: 'white', align: 'left', stroke: 'rgba(0,0,0,0)', srokeThickness: 4};
